/*
 * The simulation half of the skeleton code.
 * This should condtain only the parts relevant to the simulation.
 */

#include <rfftw.h>              //the numerical simulation FFTW library
#include <stdio.h>              //for printing the help text
#include <math.h>               //for various math functions
// We don't need the GLUT library here because this is just the simulation
...
class Simulation {
    public:
        ...
        float Simulation::max(float x, float y) {
            return x > y ? x : y; // Fixed max function
        }
        ...
        void Simulation::do_one_simulation_step(void) {
            if (!frozen)
            {
              ...
              glutPostRedisplay(); // Eliminate this call to the glut library because we don't import it here?
            }
        }
...
// I feel like I'm doing somethign wrong. Use header files maybe?